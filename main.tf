...
module "stream_analytics_clusters" {
  source                    = "git::https://github.com/AeternaModules/azurerm_stream_analytics_cluster.git?ref=v5.0.0"
  stream_analytics_clusters = local.stream_analytics_clusters
}

module "stream_analytics_jobs" {
  source                = "git::https://github.com/AeternaModules/azurerm_stream_analytics_job.git?ref=v5.0.0"
...
module "stream_analytics_managed_private_endpoints" {
  source                                     = "git::https://github.com/AeternaModules/azurerm_stream_analytics_managed_private_endpoint.git?ref=v5.0.0"
...
module "stream_analytics_function_javascript_uda" {
  source                                   = "git::https://github.com/AeternaModules/azurerm_stream_analytics_function_javascript_uda.git?ref=v5.0.0"
...
module "stream_analytics_function_javascript_udfs" {
  source                                    = "git::https://github.com/AeternaModules/azurerm_stream_analytics_function_javascript_udf.git?ref=v5.0.0"
...
module "stream_analytics_output_servicebus_topics" {
  source                                    = "git::https://github.com/AeternaModules/azurerm_stream_analytics_output_servicebus_topic.git?ref=v5.0.0"
...
module "stream_analytics_output_synapses" {
  source                           = "git::https://github.com/AeternaModules/azurerm_stream_analytics_output_synapse.git?ref=v5.0.0"
  stream_analytics_output_synapses = local.stream_analytics_output_synapses
  depends_on                       = [module.stream_analytics_jobs]
}

module "stream_analytics_output_tables" {
  source                         = "git::https://github.com/AeternaModules/azurerm_stream_analytics_output_table.git?ref=v5.0.0"
  stream_analytics_output_tables = local.stream_analytics_output_tables
  depends_on                     = [module.stream_analytics_jobs]
}

module "stream_analytics_reference_input_blobs" {
  source                                 = "git::https://github.com/AeternaModules/azurerm_stream_analytics_reference_input_blob.git?ref=v5.0.0"
...
module "stream_analytics_reference_input_mssqls" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_stream_analytics_reference_input_mssql.git?ref=v5.0.0"
...
module "stream_analytics_stream_input_blobs" {
  source                              = "git::https://github.com/AeternaModules/azurerm_stream_analytics_stream_input_blob.git?ref=v5.0.0"
...
module "stream_analytics_stream_input_eventhubs" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_stream_analytics_stream_input_eventhub.git?ref=v5.0.0"
...
module "stream_analytics_stream_input_eventhub_v2s" {
  source                                     = "git::https://github.com/AeternaModules/azurerm_stream_analytics_stream_input_eventhub_v2.git?ref=v5.0.0"
...
module "stream_analytics_stream_input_iothubs" {
  source                                = "git::https://github.com/AeternaModules/azurerm_stream_analytics_stream_input_iothub.git?ref=v5.0.0"
